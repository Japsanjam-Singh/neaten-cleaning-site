...
const AboutUs = () => {
  ...
  <div className="max-w-7xl mx-auto px-6 lg:px-12 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
    ...
    {/* Left Side - Content */}
    <div>
      <p className="text-lg uppercase font-medium text-[#00796B] tracking-widest">
        Trusted Experts in Cleaning Excellence
      </p>
      <h2 className="mt-3 text-5xl font-extrabold text-gray-800 leading-snug">
        Professional Cleaning, Built on <span className="text-[#009688]">Trust & Quality</span>
      </h2>
      <p className="mt-6 text-lg text-gray-700 leading-relaxed">
        <strong>Neaten</strong> was founded in <strong>2021 in British Columbia</strong> and, focusing solely on 
        providing the best services, is now <strong>exclusively operating in Alberta</strong>. Our goal is to provide <s> </s> 
        <strong>eco-friendly, high-quality</strong> cleaning services that ensure every space is <s> </s>
...
<section className="w-full py-24 bg-white text-gray-900">
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        {/* ✅ Section Heading */}
        <h2 className="text-5xl font-extrabold text-gray-800 leading-snug text-left border-l-4 border-[#009688] pl-6">
          Why <span className="text-[#00796B]">Choose Neaten?</span>
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mt-12">
          ...
          {/* 🔹 Professional Team */}
          <div className="flex items-start space-x-4">
            <Users className="text-[#00796B] w-10 h-10" />
            <div>
    ...
    <section className="w-full py-24 bg-gray-50 text-gray-900">
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        {/* ✅ Section Heading */}
        <h2 className="text-5xl font-extrabold text-gray-800 leading-snug text-left border-l-4 border-[#009688] pl-6">
          Our <span className="text-[#00796B]">Mission & Values</span>
        </h2>
        <p className="mt-4 text-lg text-gray-700 max-w-3xl leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mt-12">
          ...
          {/* 🔹 Customer Commitment */}
          <div className="flex items-start space-x-4">
            <Handshake className="text-[#00796B] w-10 h-10" />
            <div>
          ...
          <div className="flex items-start space-x-4">
            <Award className="text-[#00796B] w-10 h-10" />
            <div>
    ...
    <section className="w-full py-24 bg-gray-50 text-gray-900">
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        {/* ✅ Section Heading */}
        <h2 className="text-5xl font-extrabold text-gray-800 leading-snug border-l-4 border-[#009688] pl-6">
          A Cleaning Partner You Can <span className="text-[#00796B]">Trust</span>
        </h2>
        <p className="mt-4 text-lg text-gray-700 max-w-3xl leading-relaxed">
        ...
        <div className="mt-12 flex flex-col lg:flex-row justify-between items-center gap-10">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md max-w-md">
            <Quote className="text-[#00796B] w-8 h-8 mb-4" />
            <p className="text-lg text-gray-700 italic">
              "Neaten transformed our workspace! The team is punctual, professional, and incredibly thorough.  
              We highly recommend their services!"
            </p>
            <h4 className="mt-4 text-[#00796B] font-semibold">— Sarah M., Office Manager</h4>
          </div>
          ...
          <div className="max-w-md">
            ...
            <div className="mt-6 space-y-4">
              <a 
                ...
                className="flex items-center space-x-3 text-[#00796B] text-lg font-semibold hover:text-[#009688] transition"
              >
                <Phone className="w-6 h-6" /> <span>+1 (123) 456-7890</span>
              </a>
              <a 
